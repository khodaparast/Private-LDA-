 ...
 */
public class Party4 implements MessageListener {
    ...
    public void start() {
        ...
        try {
            ...
            Destination senDestination = (Destination) initContext.lookup(PARTY_4_OUTPUT_Q);
            Destination reaDestination = (Destination) initContext.lookup(PARTY_4_INPUT_Q);
            initContext.close();
...
//--------------------------------------------------------------------------------------------------------------------------------------
//Mean
            TrainCommon trainCommon=new TrainCommon(FILE_PATH_PARTY_4);
            HashMap<String, ArrayList> localAttributesMean = trainCommon.getLocalAttributesMean();

            System.out.println("state[1] >>>>>>>>> 0");
            while (hashMessage.get("p3.1") == null) {//wait here until receive encrypted value of p2
                Thread.sleep(50);
            }
            ArrayList<BigInteger> sumOfTwoEncryptedMean_Y =
                    getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p3.1"), getEncrypted(localAttributesMean.get("mu_of_class_Y_local"), n, g, r));
            //Send messages
            ObjectMessage message = session.createObjectMessage();
            message.setObject(sumOfTwoEncryptedMean_Y);
            message.setStringProperty("sender", "p4.1");
            ...
            while (hashMessage.get("p3.2") == null) {
                Thread.sleep(50);
            }

            ArrayList<BigInteger> sumOfTwoEncryptedMean_N = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p3.2"), getEncrypted(localAttributesMean.get("mu_of_class_N_local"), n, g, r));
            message.setObject(sumOfTwoEncryptedMean_N);
            message.setStringProperty("sender", "p4.2");
            message.setStringProperty("type", "mean");
            sender.send(message);
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p3.3") == null) {
                Thread.sleep(50);
            }
            ...
            message.setStringProperty("sender", "p4.4");
            message.setStringProperty("type", "covariance");
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p3.5") == null) {
                Thread.sleep(50);
            }
            ...
            message.setStringProperty("sender", "p4.5");
            message.setStringProperty("type", "covariance");
            message.setObject(en_cov_No_int_P12);
            sender.send(message);

            System.out.println("state[5] >>>>>>>>> 0");
            while (hashMessage.get("p3.6") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_No_deci_P2= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p3.6");
            ...
            message.setStringProperty("sender", "p4.6");
            message.setStringProperty("type", "covariance");
