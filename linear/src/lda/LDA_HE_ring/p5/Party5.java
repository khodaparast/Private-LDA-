...
//Mean
            ...
            while (hashMessage.get("p4.1") == null) {//wait here until receive encrypted value of p2
                Thread.sleep(50);
            }
            ArrayList<BigInteger> sumOfTwoEncryptedMean_Y = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p4.1"), getEncrypted(localAttributesMean.get("mu_of_class_Y_local"), n, g, r));
            //Send messages
            ...
            while (hashMessage.get("p4.2") == null) {
                Thread.sleep(50);
            }

            ArrayList<BigInteger> sumOfTwoEncryptedMean_N = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p4.2"), getEncrypted(localAttributesMean.get("mu_of_class_N_local"), n, g, r));
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p4.3") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_Yes_int_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p4.3");
            ...
            while (hashMessage.get("p4.4") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_Yes_deci_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p4.4");
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p4.5") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_No_int_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p4.5");
            ...
            System.out.println("state[5] >>>>>>>>> 0");
            while (hashMessage.get("p4.6") == null) {
                Thread.sleep(50);
            }
