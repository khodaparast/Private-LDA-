 ...
 */
public class Party6 implements MessageListener {
    ...
    public void start() {
        ...
        try {
            ...
            Destination senDestination = (Destination) initContext.lookup(PARTY_6_OUTPUT_Q);
            Destination reaDestination = (Destination) initContext.lookup(PARTY_6_INPUT_Q);
            initContext.close();
...
//--------------------------------------------------------------------------------------------------------------------------------------
//Mean
            TrainCommon trainCommon=new TrainCommon(FILE_PATH_PARTY_6);
            HashMap<String, ArrayList> localAttributesMean = trainCommon.getLocalAttributesMean();

            System.out.println("state[1] >>>>>>>>> 0");
            while (hashMessage.get("p5.1") == null) {//wait here until receive encrypted value of p2
                Thread.sleep(50);
            }
            ArrayList<BigInteger> sumOfTwoEncryptedMean_Y = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p5.1"), getEncrypted(localAttributesMean.get("mu_of_class_Y_local"), n, g, r));
            //Send messages
            ObjectMessage message = session.createObjectMessage();
            message.setObject(sumOfTwoEncryptedMean_Y);
            message.setStringProperty("sender", "p6.1");
            ...
            while (hashMessage.get("p5.2") == null) {
                Thread.sleep(50);
            }

            ArrayList<BigInteger> sumOfTwoEncryptedMean_N = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p5.2"), getEncrypted(localAttributesMean.get("mu_of_class_N_local"), n, g, r));
            message.setObject(sumOfTwoEncryptedMean_N);
            message.setStringProperty("sender", "p6.2");
            message.setStringProperty("type", "mean");
            sender.send(message);
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p5.3") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_Yes_int_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p5.3");
            ...
            message.setStringProperty("sender", "p6.3");
            message.setStringProperty("type", "covariance");
            message.setObject(en_cov_Yes_int_P23);
            sender.send(message);

            System.out.println("state[5] >>>>>>>>> 0");
            while (hashMessage.get("p5.4") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_Yes_deci_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p5.4");
            ...
            message.setStringProperty("sender", "p6.4");
            message.setStringProperty("type", "covariance");
            message.setObject(en_cov_Yes_deci_P23);
            sender.send(message);

            System.out.println("state[6] >>>>>>>>> 0 ");
            while (hashMessage.get("co.4") == null || hashMessage.get("co.5") == null) {// wait here until receive decrypted  covariance of class Yes
                Thread.sleep(50);
            }
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p5.5") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_No_int_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p5.5");
            ...
            message.setStringProperty("sender", "p6.5");
            message.setStringProperty("type", "covariance");
            message.setObject(en_cov_No_int_P12);
            sender.send(message);

            System.out.println("state[5] >>>>>>>>> 0");
            while (hashMessage.get("p5.6") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_No_deci_P2= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p5.6");
            ...
            message.setStringProperty("sender", "p6.6");
            message.setStringProperty("type", "covariance");
            ...
            ArrayList<ArrayList<BigInteger>> totalCovarianceNoInt = (ArrayList<ArrayList<BigInteger>>) hashMessage.get("co.4");
            ArrayList<ArrayList<BigInteger>> totalCovarianceNoDeci = (ArrayList<ArrayList<BigInteger>>) hashMessage.get("co.5");
//--------------------------------------------------------------------------------------------------------------------------------------
            while (true) {
                Thread.sleep(1000);
