...
public class CoordinatorJMSChannel implements MessageListener {
    ...
    public void start() throws IOException {
        ...
        try {
            System.out.println("Coordinator start block ...ring........");
            ...
            MessageProducer[] senders = new MessageProducer[]{sender1, sender2, sender3, sender4, sender5};

            MessageConsumer receiver = session.createConsumer((Destination) initContext.lookup("Queue06"));
            ...
            while (hashMessage.get(MEAN_SENDER_TO_COORDINATOR_YES) == null) {
                Thread.sleep(50);
            }
...
//Covariance Yes
            ...
            while (hashMessage.get(COV_SENDER_TO_COORDINATOR_YES_INT) == null) {
                Thread.sleep(50);
            }
