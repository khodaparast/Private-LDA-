...
//Mean
            ...
            while (hashMessage.get("p2.1") == null) {
                Thread.sleep(50);
            }
            ArrayList<BigInteger> sumOfTwoEncryptedMean_Y = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p2.1"), getEncrypted(localAttributesMean.get("mu_of_class_Y_local"), n, g, r));
            //Send messages
            ...
            while (hashMessage.get("p2.2") == null) {
                Thread.sleep(50);
            }
            ArrayList<BigInteger> sumOfTwoEncryptedMean_N = getSumOfTwoEncryptedList((ArrayList<BigInteger>) hashMessage.get("p2.2"), getEncrypted(localAttributesMean.get("mu_of_class_N_local"), n, g, r));
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p2.3") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_Yes_int_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p2.3");
            ...
            while (hashMessage.get("p2.4") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_Yes_deci_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p2.4");
...
//--------------------------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("state[4] >>>>>>>>> 0");
            while (hashMessage.get("p2.5") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_No_int_P1= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p2.5");
            ...
            System.out.println("state[5] >>>>>>>>> 0");
            while (hashMessage.get("p2.6") == null) {
                Thread.sleep(50);
            }
            ArrayList<ArrayList<BigInteger>> en_cov_No_deci_P2= (ArrayList<ArrayList<BigInteger>>) hashMessage.get("p2.6");
            ...
            System.out.println("state[6] >>>>>>>>> 0 ");
            while (hashMessage.get("co.5") == null || hashMessage.get("co.7") == null) {
                Thread.sleep(50);
            }
